...
admins = ["ueacedbe88bf6e2c5cf6188b3a4a26e18"]
Rx3 = ["ueacedbe88bf6e2c5cf6188b3a4a26e18"]
Rx2 = ["ueacedbe88bf6e2c5cf6188b3a4a26e18"]
Rx1 = ["ueacedbe88bf6e2c5cf6188b3a4a26e18"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"Auto like By~http://line.me/ti/p/4bvwOIMft8 ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        cl.sendText(msg.to,"รวมอยู่ในบัญชีดำแล้ว。")
                        wait["wblack"] = False
                    else:
...
#--------------------------------------------------------
                ...
                if wait["autoAdd"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Turned off。")
            elif "Mesadd:" in msg.text:
                wait["message"] = msg.text.replace("Mesadd:","")
...
#-----------------------------------------------------------                          
                ...
                if msg.contentMetadata is not None:
                    ...
                    for target in targets:
                        ...
                        pass
            elif "T1 fuck" in msg.text:
				OWN = "u5a8f1f79740e3dc876a13ab7f7381340"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("T1 fuck","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
						...
						for target in targets:
							try:
								if msg.from_ not in target:
									...
									ki.kickoutFromGroup(msg.to, [target])							   
									pass
            elif "T2 fuck" in msg.text:
				OWN = "ucb644059c131d05bab504a74317f8738"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("T2 fuck","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
            ...
            elif "T3 fuck" in msg.text:
				OWN = "ubd42061af83fd84a8a667c4b4e7b0599"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("T3 fuck","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
...
#-----------------------------------------------------------
		...
		cl.sendText(msg.to,"ลบแชททั้งหมด")
		...
		try:
		    ...
		    cl.updateProfile(profile)
		    cl.sendText(msg.to, "โปรไฟล์สำรองที่สำเร็จ")
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to, "Bot ได้เริ่มใหม่แล้ว")
		restart_program()
		print "@Restart"
...
#-----------------------------------------------------------
                ...
                if msg.from_ in user1:
                    red = re.compile(re.escape('mimic '),re.IGNORECASE)
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param1 in protection:
                        OWN = "ueacedbe88bf6e2c5cf6188b3a4a26e18","u5a8f1f79740e3dc876a13ab7f7381340","ucb644059c131d05bab504a74317f8738","ubd42061af83fd84a8a667c4b4e7b0599"
                    if op.param2 in OWN:
